...
cmd:option('-content_name', 'potrait1', "The content image path")
cmd:option('-style_name', 'picasso', "The style image path")
cmd:option('-ini_name', 'portrait1', "The initial image path to start with (if ini_method set to image)")
